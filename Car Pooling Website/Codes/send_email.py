...
def send_email(name, surname, from_place, to_place, phone_number,e_mail_receiver,case): # Reference: https://www.youtube.com/watch?v=ueqZ7RL8zxM&t=129s
    email_sender = 'DB2.352.final@gmail.com' # Email that I'll use to send the email.
    app_password = 'eipgcertsgsoxtgl' # Please notice that this is the password of my application and not my gmail. 
